...
# Curses color index for NWS palette entry i (1-indexed, 1..N_RADAR_COLORS)
...
# Curses pair index for single-color radar cell (fg=nws_idx, bg=-1)
...
# Curses pair index for two-color radar cell (both fg and bg are radar colors)
...
# ---------------------------------------------------------------------------
# Major US cities for radar overlay (code, lat, lon)
# ---------------------------------------------------------------------------
...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "radar": {
        ...
        "max_city_labels": 20,
        "ascii_ramp": " .:-=+*#%@",
        # Animation: how many frames to fetch from MRMS time series
        "animation_frames": 4,
        # Interval between animation frames in seconds
        "animation_interval_s": 0.5,
        # Spacing between fetched timestamps in minutes
